...
#             dcc.Dropdown(
#                 id = 'username-selection-dropdown-new-user',
...
# # Callbacks
# @app.callback(Output('beer-loader-new-user', 'style'),
#                 [Input('search-button-new-user', 'n_clicks')],
#                 [State('beer-selection-dropdown-new-user', 'value')])
...
#                         dcc.Dropdown(
#                             id = 'feature-selection-dropdown-new-user',
...
#                         dcc.Dropdown(
#                             id = 'model-selection-dropdown-new-user',
...
#                     html.Button('Build Model', id='model-button-new-user', className='btn btn-outline-primary'),
#                     dcc.Loading(id="loading-model", children=[html.Div(id="loading-model-output")], type="default"),
#                 ]),
#                 html.Div(className='row', children=[
#                     html.Div(id='model-results-new-user')
#                 ])
#             ])
#         else:
#             return html.Div([
...
# @app.callback(Output('model-results-new-user', 'children'),
#                 [Input('model-button-new-user', 'n_clicks')],
#                 [State('username-selection-dropdown-new-user', 'value'),
#                  State('feature-selection-dropdown-new-user', 'value'),
#                  State('model-selection-dropdown-new-user', 'value')])
...
#         with open('new-user-model.pkl', 'wb') as file:
#             pickle.dump(d, file)
...
# @app.callback(Output('prediction-results-new-user', 'children'),
#                 [Input('prediction-button-new-user', 'n_clicks')],
#                 [State('beer-selection-dropdown-new-user', 'value')])
# def predict_beer_rating(n_clicks, beer):

#     if n_clicks != None:
#         with open('new-user-model.pkl', 'rb') as file:
#             d = pickle.load(file)
#             model = d['model']
...
# @app.callback(Output('ranking-results-new-user', 'children'),
#                 [Input('ranking-button-new-user', 'n_clicks')],
#                 [State('ranking-beer-selection-dropdown-new-user', 'value')])
...
# @app.callback(Output('suggestion-results-new-user', 'children'),
#                 [Input('suggestion-button-new-user', 'n_clicks')])
...
#                             dcc.Dropdown(
#                                 id = 'beer-selection-dropdown-new-user',
#                                 options = data,
#                                 multi = False
#                             )
#                         ]),
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Button('Predict', id='prediction-button-new-user', className='btn btn-outline-primary')
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Div(id='prediction-results-new-user')
#                     ]),
#                 ]),
#             ]),
#         elif value == 'rank':
...
#                         html.Div(className='col-lg-5 m-4', children=[
#                             dcc.Dropdown(
#                                 id = 'ranking-beer-selection-dropdown-new-user',
#                                 options = data,
#                                 multi = True
#                             )
#                         ]),
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Button('Rank', id='ranking-button-new-user', className='btn btn-outline-primary')
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Div(id='ranking-results-new-user')
#                     ]),
#                 ]),
#             ]),
#         elif value == 'suggest':
...
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Button('Suggest', id='suggestion-button-new-user', className='btn btn-outline-primary')
#                     ]),
#                     html.Div(className='row', children=[
#                         html.Div(id='suggestion-results-new-user')
#                     ]),
#                 ]),
#             ]),
